...
## Locating things on a map

<!-- Give them the location for Rosenstiel in geographic and UTM -->

<!-- Ask them if they can place them on the map -->

<!-- Then ask if they know what it is -->

<!-- This should help them realize we need three things: coordinates, CRS, attributes -->
...
This information is enough to place the point on a map, but not enough to convey information about the place
